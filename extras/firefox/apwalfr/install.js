...
var XpiInstaller = {
	...
	extFullName: 'a.pwal.fr', // The name displayed to the user (don't include the version)
	extShortName: 'apwalfr', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1',
	extAuthor: 'Gael Pasgrimaud',
